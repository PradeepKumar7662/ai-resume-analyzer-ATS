...
const Upload = () => {
    ...
    try {
        ...
        console.log("2. Uploaded file:", uploadedFile);
        ...
        console.log("3. Converted image:", imageFile);
        ...
        console.log("6. AI response:", feedback);
        ...
        console.log("7. AI text:", feedbackText);
